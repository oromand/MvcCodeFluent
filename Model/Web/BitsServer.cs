...
// </auto-generated>
//------------------------------------------------------------------------------
// CodeFluent Entities generated (http://www.softfluent.com). Date: Saturday, 19 November 2016 13:35. Build: 1.0.61214.0842
namespace ModelCodeFluent.Web
{
    ...
    public partial class ModelCodeFluentBitsServer: CodeFluent.Runtime.BinaryServices.BitsServer
    {
		...
		public ModelCodeFluentBitsServer()
			:this(CodeFluent.Runtime.CodeFluentContext.Get(ModelCodeFluent.Constants.ModelCodeFluentStoreName))
		{
		}
		
		public ModelCodeFluentBitsServer(CodeFluent.Runtime.CodeFluentContext context)
			:base(context)
		{
		}
        ...
        protected override void OnInformation(object ctx)
        {
			...
			throw new System.InvalidOperationException(ModelCodeFluent.Resources.Manager.GetStringWithDefault("bitsServerInvalidUrl", "Invalid url '{0}'.", new object[]{context.Request.Url}));
        }
		...
		public static ModelCodeFluentBitsServer Current
		{
			get
			{
				if (_current == null)
				{
					_current = new ModelCodeFluentBitsServer();
				}
				return _current;
			}
		}
