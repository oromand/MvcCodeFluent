...
using ModelCodeFluent.Identity;
...
namespace MvcCodeFluent
{
    ...
    {
        public UserManager(ModelCodeFluent.Web.Security.UserStore store)
            : base(store)
        {
        }
        ...
        {
            var manager = new UserManager(new ModelCodeFluent.Web.Security.UserStore());
